...
public class Blood_information_recipes_Imple implements Blood_information_commensence_inter {
    private Informationcommensence_Inter informationdetilsInter;
    private ModelInter modelInter;
    public Blood_information_recipes_Imple(Informationcommensence_Inter informationdetilsInter){
    ...
    public void showcommonsencedata() {
        ...
        modelInter.get("http://api.wws.xywy.com?act=zixun&fun=getHealthPlazeList&version=version2&tag=zj&sign=2e0d0887581be1c35794ee4c13b00cae&typeid=7938&dir=zhuzhan_ys",
                map, new MyCallBack() {
                    @Override
