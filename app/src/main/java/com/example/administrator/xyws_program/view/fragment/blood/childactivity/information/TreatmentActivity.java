...
import com.example.administrator.xyws_program.presenter.Blood.Blood_information_treatment_Imple;
...
public class TreatmentActivity extends BaseActivity  implements Informationcommensence_Inter{


    @BindView(R.id.treatment_toolbar_backimg)
    ImageView treatmentToolbarBackimg;
    @BindView(R.id.treatment_toolbar)
    Toolbar treatmentToolbar;
    @BindView(R.id.treatmentrecyclerview)
    PullToRefreshRecyclerView treatmentrecyclerview;
    ...
    protected void loadData() {
        inter = new Blood_information_treatment_Imple(this);
    ...
    @OnClick(R.id.treatment_toolbar_backimg)
    ...
    public void showdata(List<Blood_commensence_Bean.DataBean> list) {
        ...
        treatmentrecyclerview.setPullRefreshEnabled(false);
        //设置下拉刷新下拉加载
        treatmentrecyclerview.setLoadingMoreEnabled(false);
        treatmentrecyclerview.setPullRefreshEnabled(false);
        treatmentrecyclerview.displayLastRefreshTime(false);
    }
}
