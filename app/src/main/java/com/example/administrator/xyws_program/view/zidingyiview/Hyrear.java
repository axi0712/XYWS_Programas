...
public class Hyrear extends View {
    ...
    //-------------必须给的资源相关-------------
    private String[] xStr = new String[]{"2016年12月", "2", "4", "6", "8"};
    ...
    public Hyrear(Context context, String[] yStr) {
        super(context);
        this.yStr=yStr;
    }

    public Hyrear(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public Hyrear(Context context, AttributeSet attrs, int defStyleAttr) {
