...
import com.example.administrator.xyws_program.view.fragment.blood.childactivity.information.Informationcommensence_Inter;
...
public class Blood_information_commonsence_Imple implements Blood_information_commensence_inter {
   private Informationcommensence_Inter informationdetilsInter;
   private ModelInter modelInter;
    public Blood_information_commonsence_Imple(Informationcommensence_Inter informationdetilsInter){
    ...
    public void showcommonsencedata() {
        ...
        modelInter.get("http://api.wws.xywy.com?act=zixun&fun=getHealthPlazeList&version=version2&tag=zj&sign=2e0d0887581be1c35794ee4c13b00cae&typeid=18031&dir=zhuanti_nk",
                map, new MyCallBack() {
            @Override
