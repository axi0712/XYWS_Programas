...
public class Hweek extends View {
    ...
    //-------------必须给的资源相关-------------
    private String[] xStr = new String[]{"6月12", "13", "14", "15", "16","17","18"};
    ...
    public Hweek(Context context, String[] yStr) {
        super(context);
        this.yStr=yStr;
    }

    public Hweek(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public Hweek(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void drawLine(Canvas canvas) {
        ...
        //画折线点
        canvas.drawCircle(660,-250, 9, linePaint);
        //画折线点
        canvas.drawCircle(660,-500, 9, linePaint);
